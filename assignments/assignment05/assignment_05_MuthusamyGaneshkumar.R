...
# Name: Muthusamy, Ganeshkumar
# Date: 2020-06-26

## Set the working directory to the root of your DSC 520 directory
setwd("/Users/ganeshkumar/GitHub/dsc520")
...
data_df %>% ggplot(aes(tech_spending,suicides)) + geom_point(aes(color = year),alpha = 0.5) +
  scale_color_gradientn(colours = c("red","yellow","orange")) + theme_bw() + geom_smooth(method = "lm") +
  labs(title = "Spending vs suicides")
